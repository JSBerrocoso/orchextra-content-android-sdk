...
@Module public class ContentGridLayoutViewModule {
  ...
  @Provides ContentViewPresenter provideContentViewPresenter(
      OcmController ocmController, OcmControllerKt ocmControllerKt, Authoritation authoritation) {
    return new ContentViewPresenter(ocmController, ocmControllerKt, authoritation);
  }
